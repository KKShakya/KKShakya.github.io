...
import { BsGithub, BsLinkedin, BsPerson, BsReverseLayoutTextWindowReverse } from 'react-icons/bs';
...
const sendEmail = (e) => {
  ...
  emailjs.sendForm(process.env.REACT_APP_EMAIL_KEY, 'template_hnyf23b', e.target,process.env.REACT_APP_PUBLIC_KEY )
    .then((result) => {
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                <Link href="https://www.github.com/KKShakya/">
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.linkedin.com/in/krishnashakya/">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
              ...
              <Box
                ...
                <VStack spacing={5} ref={form}>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      <InputLeftElement children={<BsReverseLayoutTextWindowReverse />} />
                      <Input
                        type="text"
                        name="subject"
                        placeholder="Subject"
